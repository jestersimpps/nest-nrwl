...
export const Changes : HistoricalChange[] = [
  {
  ...
  },
  {
    ...
    project_id: 1,
    description: '\'PbRen_04A.pdf\' - renseignements urbanistiques 02'
  },  {
    author: 'wim.bonen@fednot.be',
    changeType: 'delete',
    date: new Date(),
    title: 'Efface fichier',
    project_id: 1,
    description: '\'PbRen_040A.pdf\' - renseignements urbanistiques 01 '
  }, {
    author: 'wim.bonen@fednot.be',
    changeType: 'edit',
    date: new Date(),
